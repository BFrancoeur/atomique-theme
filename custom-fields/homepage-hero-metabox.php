...
class HomePageHeroContentMetaBox
{
    ...
    private $meta_fields = array(
        ...
        array(
            'label' => 'Primary CTA Message',
            'id' => 'hph_prim_cta_msg',
            'type' => 'text',
        ),

        array(
            'label' => 'Secondary CTA Message',
            'id' => 'hph_second_cta_msg',
            'type' => 'text',
        ),

        array(
            'label' => 'Primary CTA Button Message',
            'id' => 'hph_prim_cta_btn_msg',
            'type' => 'text',
        ),

        array(
            'label' => 'Primary Button Link',
            'id' => 'hph_prim_btn_link',
            'type' => 'url',
        ),

        array(
            'label' => 'Secondary CTA Button Message',
            'id' => 'hph_second_cta_btn_msg',
            'type' => 'text',
        ),

        array(
            'label' => 'Secondary CTA Button Link',
            'id' => 'hph_second_cta_btn_link',
            'type' => 'url',
        )
    ...
    {
        wp_nonce_field('HomePageHeroContent_data', 'HomePageHeroContent_nonce');
        echo 'Use this metabox to add or change the hero section content. ';
...
?><script>
            jQuery(document).ready(function($) {
                ...
                {
                    if (!isset($_POST['HomePageHeroContent_nonce']))
                        return $post_id;
                    $nonce = $_POST['HomePageHeroContent_nonce'];
                    if (!wp_verify_nonce($nonce, 'HomePageHeroContent_data'))
                        return $post_id;
